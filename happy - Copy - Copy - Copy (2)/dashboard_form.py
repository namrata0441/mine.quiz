...
import resource_rc  # Assuming you have a resource_rc.py generated from a .qrc file

# Import custom widgets (ensure these files exist in the same directory or Python path)
...
from quiz_form import QuizUiForm # CORRECT: Import QuizUiForm here
